...
The initial public release offers ProgHard Link Base 0.2.3 for ESP8266, ESP32
and ESP32-C3. Installation erases the target. Use a USB data cable, select the

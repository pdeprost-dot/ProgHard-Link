...
Build ESP32, ESP32-C3 and ESP32-C6 sequentially. Give every target an isolated build
...
Use the ESP8266 sketch `.bin` and the ESP32-family `.merged.bin` images. The
merged images include bootloader, partition table, boot application and
...
| ESP32-C6 | 8388608 | `9e0a477c99acb5a8269a20b8bd8e4799d574cc5b11dc8c86d1f84f8eb33fd797` |
...
1,395,929-byte application inside its 4 MiB merged image. ESP32-C6 used
1,408,284/3,342,336 bytes program storage and 47,348/327,680 bytes globals;
its installable merged image is 8 MiB.

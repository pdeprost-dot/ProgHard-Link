...
Planned physical validation targets after the initial public release:

- ESP32-C6: Waveshare ESP32-C6-Touch-LCD-1.47;
- ESP32-S3: Seeed Studio ESP32-S3 board with camera and microphone.

Neither target is currently supported. The build/Web Installer chain should

...
The five results are written below `build/firmware/output/`. The build script
...
`esp-14.2.0_20260121`) for ESP32, ESP32-C3, ESP32-C6 and ESP32-S3.
...
The ESP32-S3 target uses `esp32:esp32:esp32s3` with the same 8 MB flash,
partition and USB CDC settings. It uses the common ESP32 Base source.

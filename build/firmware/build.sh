...
rm -rf /tmp/proghard-build-esp8266 /tmp/proghard-build-esp32 /tmp/proghard-build-esp32-c3
rm -rf /tmp/proghard-out-esp8266 /tmp/proghard-out-esp32 /tmp/proghard-out-esp32-c3
rm -rf "$output"
mkdir -p "$output/esp8266" "$output/esp32" "$output/esp32-c3"

...
Install the public `ProgHard-Link-0.4.8.zip` release with **Sketch > Include Library >
...
profiles are NodeMCU 1.0 with **4MB (FS:2MB OTA:~1019KB)** and ESP32C3 Dev
Module with **Minimal SPIFFS (1.9 MB APP with OTA)**.
